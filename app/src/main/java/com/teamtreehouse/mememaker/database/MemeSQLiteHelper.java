...
public class MemeSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static String CREATE_MEMES =
            "CREATE TABLE " + MEMES_TABLE + "("
                    ...
                    COLUMN_MEME_NAME + " TEXT, " + COLUMN_MEME_CREATE_DATE + " INTEGER)";
    ...
    public static final String CREATE_ANNOTATIONS = "CREATE TABLE " + ANNOTATIONS_TABLE
            + "(" + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
    ...
    public static final String ALTER_ADD_CREATE_DATE = "ALTER TABLE " + MEMES_TABLE +
